...
class ProgrammeImpactDataset
{
    ...
    public static function glanceStats(): array
    {
        return [
            ...
            ['key' => 'jobs_enabled', 'label' => 'Jobs enabled', 'value' => 400, 'unit' => 'count'],
            ['key' => 'enterprises_created', 'label' => 'Enterprises created', 'value' => 25, 'unit' => 'count'],
            ['key' => 'placed_interns', 'label' => 'Jobs enabled', 'value' => 400, 'unit' => 'count'],
