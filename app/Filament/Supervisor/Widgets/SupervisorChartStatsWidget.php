...
class SupervisorChartStatsWidget extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        // Get enrollments for supervisor's courses for the last 7 days
        $enrollments = Enrollment::select(
            DB::raw('DATE(enrollments.created_at) as date'),
            DB::raw('COUNT(*) as count')
        )
        ->whereHas('course', function ($query) use ($supervisorId) {
