...
namespace App\Filament\Supervisor\Resources\ModuleResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\Action::make('questions')
                    ...
                    ->url(fn ($record) => \App\Filament\Supervisor\Resources\ModuleTestResource::getUrl('edit', ['record' => $record])),
