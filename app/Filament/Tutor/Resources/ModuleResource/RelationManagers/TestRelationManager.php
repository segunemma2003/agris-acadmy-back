...
namespace App\Filament\Tutor\Resources\ModuleResource\RelationManagers;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\Action::make('questions')
                    ...
                    ->url(fn ($record) => \App\Filament\Tutor\Resources\ModuleTestResource::getUrl('edit', ['record' => $record])),
